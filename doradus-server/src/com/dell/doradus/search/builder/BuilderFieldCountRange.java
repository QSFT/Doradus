...
import com.dell.doradus.search.filter.FilterFieldCountRange;
import com.dell.doradus.search.query.FieldCountRangeQuery;
import com.dell.doradus.search.query.Query;

public class BuilderFieldCountRange extends SearchBuilder {
	...
	@Override public Filter filter(Query query) {
		FieldCountRangeQuery qu = (FieldCountRangeQuery)query;
        ...
        FilterFieldCountRange condition = new FilterFieldCountRange(qu.field, qu.range);
        return condition;
	}
