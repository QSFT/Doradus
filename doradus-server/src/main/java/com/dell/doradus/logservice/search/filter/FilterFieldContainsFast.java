...
public class FilterFieldContainsFast implements IFilter {
    ...
    public FilterFieldContainsFast(String field, String pattern) {
    ...
    @Override public boolean check(ChunkReader reader, int doc) {
        ...
        return m_value.contains(m_upper, m_lower);
    }
