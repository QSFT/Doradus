...
public class FilterFieldPatternFast implements IFilter {
    ...
    public FilterFieldPatternFast(String field, String pattern) {
    ...
    @Override public boolean check(ChunkReader reader, int doc) {
        ...
        return m_value.matchesPattern(m_upper, m_lower);
    }
