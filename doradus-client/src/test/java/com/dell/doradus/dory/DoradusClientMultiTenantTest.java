...
@Ignore
public class DoradusClientMultiTenantTest {
    ...
    private static String getOLAPSchemaJson() throws IOException, URISyntaxException {
        return new String(Files.readAllBytes(Paths.get(DoradusClientMultiTenantTest.class.getResource("/"+OLAP_SCHEMA_FILE).toURI())));
    }
