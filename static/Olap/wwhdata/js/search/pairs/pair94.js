...
x.t("example","suppose");
x.t("recipients.messageaddress.domain.isinternal=false","&shards=");
...
x.t("want","count");
x.t("want","/email/message/_aggregate");
x.t("want","recipients");
x.t("want","object");
x.t("certain","date");
...
x.t("name","message\u2019s");
x.t("wait","gets");
x.t("follows","/email/message/_aggregate");
x.t(".messageaddress.domain.name","&shards=");
...
x.t("expression","/email/message/_aggregate");
...
x.t("messageaddress.domain.isinternal=false","&shards=");
x.t("case","recipients");
